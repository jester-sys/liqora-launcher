package com.liqora.launcher.compose
...
fun LiquidGlassHomeScreen(
    ...
    var glassSettings by remember { mutableStateOf(com.liqora.launcher.compose.launcher.LiquidGlassSettings()) }
    LaunchedEffect(Unit) {
        glassSettings = com.liqora.launcher.compose.launcher.LiquidGlassSettingsRepository.loadSettings(context)
    }
